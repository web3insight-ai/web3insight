...
interface MantleCardBackProps extends HTMLAttributes<HTMLDivElement> {
  isFlipped?: boolean
}

const MantleCardBack = forwardRef<HTMLDivElement, MantleCardBackProps>(
...
MantleCardBack.displayName = 'MantleCardBack'

// Memoize to prevent re-renders during card flip animations
export default memo(MantleCardBack)
