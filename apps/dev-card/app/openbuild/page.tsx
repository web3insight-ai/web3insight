...
export default function ConnectPage() {
  ...
  // Initialize and save user type on mount (always dev for OpenBuild)
  useEffect(() => {
    setUserType('dev')
  }, [])
  ...
  const handleConnect = async () => {
    if (ready) {
      ...
      if (typeof window !== 'undefined') {
        ...
        localStorage.setItem('redirectEcosystem', 'openbuild')
      }
      // Trigger Privy login
      login()
    }
  ...
  return (
    ...
    >
      ...
      >
        <Image src="/images/openbuild-homepage-bg.png" alt="OpenBuild background" fill className="object-cover" priority />
      </motion.div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center min-h-0">
          ...
          >
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[1.1]">
              <span className="block md:inline">OpenBuild</span>
          ...
          >
            <motion.div
              className="w-[190px] h-[300px] md:w-[174px] md:h-[276px] lg:w-[200px] lg:h-[316px] rounded-[22px] shadow-[0px_18px_24px_12px_rgba(1,219,131,0.40)] overflow-hidden relative"
              style={{
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05, y: -2, backgroundColor: "#01a363" }}
              whileTap={{ scale: 0.95 }}
