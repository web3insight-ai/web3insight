...
const getActivityColor = (description: string): string => {
  if (description.includes("pushed to")) return "bg-accent-subtle0";
  ...
  if (description.includes("reviewed")) return "bg-accent-subtle0";
          ...
          {dataSource.map((activity, index) => (
            <div
              ...
              className={clsx(
                ...
                "hover:bg-bg-sunken rounded-[2px] p-3 -mx-3",
            ...
            >
              <div className="flex flex-col items-center mr-4">
                <div
                  className={clsx(
                    "flex items-center justify-center w-10 h-10 rounded-full shadow-sm border-2 border-rule",
                ...
                {index < dataSource.length - 1 && (
                  <div className="w-0.5 h-4 bg-rule mt-1" />
                )}
              </div>
              <div className="flex-1 min-w-0 pt-1">
                ...
                <div className="flex items-center gap-3 mt-2">
                  <time className="text-xs text-fg-muted font-mono">
