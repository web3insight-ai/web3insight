        ...
        <div className="space-y-4">
              ...
              return (
                <div key={data.year} className="flex flex-col items-center gap-1 min-w-0 flex-1">
                  ...
                  <div className="w-full max-w-8 flex flex-col justify-end" style={{ height: '50px' }}>
                    <div
                      className={`w-full border border-gray-200 dark:border-gray-600 transition-all duration-500 ease-out ${getIntensityColor(data.intensity)}`}
          ...
          <div className="flex items-center justify-center gap-4 pt-2">
            <div className="flex items-center gap-1">
              <div className="w-3 h-3 bg-gray-400 border border-gray-300" />
