...
import { Code2, GitBranch, GitCommit, GitPullRequest, Eye, Star, GitMerge, Plus, Trash2 } from "lucide-react";
...
const iconMap: Record<string, ReactNode> = {
  ...
  issue: <div className="w-3.5 h-3.5 rounded-full bg-orange-500 flex items-center justify-center text-xs text-white font-semibold">!</div>,
...
const getActivityIcon = (description: string): ReactNode => {
  ...
  if (description.includes("merged a pull request")) return iconMap.pull_request_merged;
