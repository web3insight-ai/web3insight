  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'relative w-full h-full overflow-hidden bg-[#0a0f0f]',
          className,
        )}
        ...
        <div className="w-full h-full flex flex-col px-[5%] pt-[3%] pb-0 print:py-[3mm] print:px-[6%]">
          ...
          <div className="flex justify-center mb-[1.2%] relative print:mb-[2.8%]">
            <div className="relative w-[70%] print:w-[85%]">
              <Image
                src="/images/mantle-title-bg.svg"
                alt=""
                width={340}
                height={58}
                priority
          ...
          <div className="flex justify-center mb-[1.5%] print:mb-[1mm]">
            <div
              ...
              style={{
                background:
                  'linear-gradient(135deg, #5EEAD4 0%, #65b3af 50%, #10B981 100%)',
              }}
            >
              <div
                className="w-full h-full rounded-full overflow-hidden"
                style={{ backgroundColor: '#65b3af' }}
              >
                <Image
                  src={avatar}
                  alt="User avatar"
          ...
          <div className="flex justify-center items-center gap-[3%] mt-[1.2%] px-[8%] text-[0.88em] print:text-[7px] print:mt-[0.5mm]">
            {twitter && (
              <>
                <a
                  ...
                  style={{ color: '#5EEAD4', maxWidth: github ? '45%' : '90%' }}
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = '#7EEEE0')
                  }
                  onMouseLeave={(e) =>
            ...
            {github && (
              <a
                ...
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 transition-colors overflow-hidden"
                style={{ color: '#5EEAD4', maxWidth: twitter ? '45%' : '90%' }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.color = '#7EEEE0'
                }}
                onMouseLeave={(e) => {
          ...
          <div className="flex-1 flex flex-col print:justify-normal justify-center pb-[3%] pt-[5%] print:pt-[1mm] print:pb-[1mm] print:mt-[4mm]">
            {hasEcosystems ? (
              <div
                ...
                style={{ backgroundColor: 'rgba(101, 179, 175, 0.1)' }}
              >
                <h3
                ...
                <div className="mt-[4%] print:hidden">
                  ...
                  >
                    ...
                    <a
                      ...
                      style={{ color: '#7EEEE0' }}
                      onMouseEnter={(e) =>
                        (e.currentTarget.style.color = '#A0F4EC')
                      }
                      onMouseLeave={(e) =>
                        (e.currentTarget.style.color = '#7EEEE0')
                      }
