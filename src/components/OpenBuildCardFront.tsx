...
interface OpenBuildCardFrontProps extends HTMLAttributes<HTMLDivElement> {
  name: string
  github: string
  twitter: string
  bio: string
...
const OpenBuildCardFront = forwardRef<HTMLDivElement, OpenBuildCardFrontProps>(
  (
    {
      name,
      github,
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'relative w-full h-full overflow-hidden bg-[#001d15]',
          className,
        )}
        ...
        <div className="w-full h-full flex flex-col px-[5%] pt-[3%] pb-0 print:py-[3mm] print:px-[6%]">
          ...
          <div className="flex justify-center mb-[1.2%] relative print:mb-[2.8%]">
            <div className="relative w-[70%] print:w-[85%]">
              <Image
                src="/images/openbuild-title-bg.svg"
                alt=""
                width={340}
                height={58}
                priority
          ...
          <div className="flex justify-center mb-[1.5%] print:mb-[1mm]">
            <div
              ...
              style={{
                background:
                  'linear-gradient(135deg, #01DB83 0%, #01a363 50%, #01DB83 100%)',
              }}
            >
              <div
                className="w-full h-full rounded-full overflow-hidden"
                style={{ backgroundColor: '#01a363' }}
              >
                <Image
                  src={avatar}
                  alt="User avatar"
          ...
          <div className="flex justify-center items-center gap-[3%] mt-[1.2%] px-[8%] text-[0.88em] print:text-[7px] print:mt-[0.5mm]">
            {twitter && (
              <>
                <a
                  ...
                  style={{ color: '#01DB83', maxWidth: github ? '45%' : '90%' }}
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = '#33E89F')
                  }
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.color = '#01DB83')
                  }
                >
                  <svg
            ...
            {github && (
              <a
                ...
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 transition-colors overflow-hidden"
                style={{ color: '#01DB83', maxWidth: twitter ? '45%' : '90%' }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.color = '#33E89F'
                }}
                onMouseLeave={(e) => {
          ...
          {inviterName && (
            <div className="flex justify-center items-center mt-[1.5%] text-[0.8em] print:text-[6px] print:mt-[0.5mm]">
              ...
              <a
                href={`/openbuild/${inviter?.id}`}
                className="flex items-center gap-1 ml-1 transition-colors"
                style={{ color: '#01DB83' }}
                onMouseEnter={(e) => (e.currentTarget.style.color = '#33E89F')}
                onMouseLeave={(e) => (e.currentTarget.style.color = '#01DB83')}
              >
                {inviter?.user_avatar && (
                  <Image
          ...
          <div className="flex-1 flex flex-col print:justify-normal justify-center pb-[3%] pt-[5%] print:pt-[1mm] print:pb-[1mm] print:mt-[4mm]">
            {hasEcosystems ? (
              <div
                ...
                style={{ backgroundColor: 'rgba(1, 219, 131, 0.1)' }}
              >
                <h3
                ...
                <div className="mt-[4%] print:hidden">
                  ...
                  >
                    ...
                    <a
                      ...
                      style={{ color: '#33E89F' }}
                      onMouseEnter={(e) =>
                        (e.currentTarget.style.color = '#66F0B8')
                      }
                      onMouseLeave={(e) =>
                        (e.currentTarget.style.color = '#33E89F')
                      }
...
OpenBuildCardFront.displayName = 'OpenBuildCardFront'

// Memoize to prevent re-renders during card flip animations
export default memo(OpenBuildCardFront)
